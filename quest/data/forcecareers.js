const requestURL = 'data/forcecareers.json';
...
fetch(requestURL)
  ...
  .then(function (jsonObject) {
    ...
    for (let i = 0; i < careers.length; i++ ) {
        ...
        p1.textContent = "Career Skills: " + careers[i].skill1 + ", " + careers[i].skill2 + ", " + careers[i].skill3 + ", " + careers[i].skill4 + ", "  + careers[i].skill5 + ", "+ careers[i].skill6 + ".";
        ...
        document.querySelector('div.forcecareers').appendChild(card);
    }
  });